...
@section('content')
<div class="row">
	@if(has_permission('dashboard.current_month_sales_widget'))
	...
	@if(has_permission('dashboard.current_day_sales_widget'))
	<div class="col-xl-3 col-md-6">
		<div class="card mb-4 dashboard-card">
			<div class="card-body">
				<div class="d-flex justify-content-between align-items-center">
	...
	@if(has_permission('dashboard.current_month_orders_widget'))
	<div class="col-xl-3 col-md-6">
		<div class="card mb-4 dashboard-card">
			<div class="card-body">
				<div class="d-flex justify-content-between align-items-center">
...
<div class="row">
	@if(has_permission('dashboard.sales_by_category_widget'))
