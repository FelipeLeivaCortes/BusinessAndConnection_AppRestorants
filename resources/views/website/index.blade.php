            ...
            <div class="col-lg-4 mb-5 {{ $package->package_type }}-plan">
                <div class="pricing-plan popular h-100 {{ $package->package_type == 'monthly' ? 'wow' : '' }} animate__zoomIn" data-wow-delay=".6s">
                    ...
                    <div class="pricing-plan-body">
                        <ul>
                            <li><i class="bi bi-check2-circle me-2"></i>{{ str_replace('-1',_lang('Unlimited'), $package->business_limit).' '._lang('Restaurant') }}</li>
                            <li><i class="bi bi-check2-circle me-2"></i>{{ str_replace('-1',_lang('Unlimited'), $package->staff_limit).' '._lang('System User') }}</li>
                            <li><i class="bi bi-check2-circle me-2"></i>{{ str_replace('-1',_lang('Unlimited'), $package->item_limit).' '._lang('Items') }}</li>
                            <li><i class="bi bi-check2-circle me-2"></i>{{ str_replace('-1',_lang('Unlimited'), $package->order_limit).' '._lang('Orders') }}</li>
                            <li><i class="bi {{ $package->payroll_module == 0 ? 'bi-x-circle' : 'bi-check2-circle' }} me-2"></i>{{ _lang('Payroll Module') }}</li>
                        </ul>
